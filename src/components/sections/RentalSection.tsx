...
export function RentalSection() {
  ...
  const baseRental = {
    ...
    features: [t('featUnlimitedM'), t('featInsurance'), t('featDeposit')]
  };

  const rentals = [
    baseRental,
    {...baseRental, name: "Ferrari F8 Tributo", price: "À partir de 1200€", image: "/images/porsche-911.png"},
    {...baseRental, name: "Lamborghini Huracán", price: "À partir de 1100€", image: "/images/s-class.png"},
    {...baseRental, name: "Audi R8 V10 Plus", price: "À partir de 700€", image: "/images/porsche-911.png"},
    {...baseRental, name: "McLaren 720S", price: "À partir de 1300€", image: "/images/v-class.png"},
    {...baseRental, name: "Porsche Taycan Turbo", price: "À partir de 600€", image: "/images/porsche-911.png"},
    {...baseRental, name: "Mercedes G63 AMG", price: "À partir de 900€", image: "/images/s-class.png"},
    {...baseRental, name: "Aston Martin Vantage", price: "À partir de 850€", image: "/images/porsche-911.png"},
    {...baseRental, name: "Bentley Continental GT", price: "À partir de 1000€", image: "/images/v-class.png"},
    {...baseRental, name: "Rolls Royce Dawn", price: "À partir de 2000€", image: "/images/s-class.png"}
  ];

  return (
    <section id="rentals" className="py-32 bg-[#050505] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {rentals.slice(0, visibleCount).map((vehicle, idx) => (
            <motion.div 
              key={idx}
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="mb-6">
                  <span className="text-white font-semibold text-xl">{vehicle.price}</span>
                  <span className="text-neutral-500 text-sm ml-2">/ {t('perDayLabel')}</span>
                </div>
